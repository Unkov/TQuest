...
namespace TQuest
{
    public class Localization
    {
        public class RU
        {
            ...
            public static string room8_description = "Позади остался подвал. Вы находитесь в разломе. Тут очень тесно и почти ничего не видно. Но впереди проход достаточно расширяется и видно развилку.";
            public static string room8_action1 = "идти: подвал";
            public static string room8_action2 = "идти: развилка";
            public static string room9_description = "Пещера резко расширилась. Тут намного свободнее. Перед вами развилка, из правой пещеры слышатся шорохи. Левая же уходит резко вниз и где-то снизу виден свет.";
            public static string room9_action1 = "идти: разлом";
            public static string room9_action2 = "идти: спуск вниз";
            public static string room9_action3 = "идти: пещера";
            public static string room10_description = "Спуск вниз достаточно крутой, но торчащие корни дерева помогают вам не сорваться. Впереди уже заметно светлее и можно разглядеть просторный грот, развилка осталась позади.";
            public static string room10_action1 = "идти: развилка";
            public static string room10_action2 = "идти: грот";
            public static string room11_description = "Посреди грота горит костер. Возле него, на большом камне лежит рюкзак и термос. В термосе еще теплый кофе. В дальнем углу свалена куча разного мусора и хлама.";
            public static string room11_action1 = "осмотреть: рюкзак";
            public static string room11_action2 = "осмотреть: хлам";
            public static string room11_action3 = "идти: спуск вниз";
            public static string room12_description = "";
            public static string room12_action1 = "осмотреть: рюкзак";
            public static string room12_action2 = "осмотреть: хлам";
            public static string room12_action3 = "идти: спуск вниз";
            public static string room13_description = "В темноте вы нащупали стену и какое-то углубление в ней. В этой нише оказалась шкатулка. В углу слышны похрипывания. Ногой вы случайно толкнули на тусклый череп.";
